<script lang="ts">
	...
	let propAction = $state<'none' | 'teleport' | 'sign'>('none');
	let signText = $state('');
	...
	function beginEditProp() {
		...
		propAction = selectedProp.actionType === 'teleport' || selectedProp.actionType === 'sign'
	...
	function changePropAction(event: Event) {
		propAction = (event.currentTarget as HTMLSelectElement).value as 'none' | 'teleport' | 'sign';
			...
			<div class="world-wrap">
				...
				>
					...
					<div
						...
						style={cameraStyle}
					>
					<div class="world-grid" style={gridStyle}></div>
