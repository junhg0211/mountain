...
const REPAIRS = [
	...
	`ALTER TABLE world_props ADD COLUMN IF NOT EXISTS teleport_x DOUBLE`,
	`ALTER TABLE world_props ADD COLUMN IF NOT EXISTS teleport_y DOUBLE`,
	`ALTER TABLE world_props ADD COLUMN IF NOT EXISTS sign_text VARCHAR(500)`,
